#include <stdio.h>
//\n\n\t7\t%|\t8\t%|\t9\n\t_\t\t_\t\t_\n\n\t4\t%|\t5\t%|\t6\n\t_\t\t_\t\t_\n\n\t1\t%|\t2\t%|\t3\n\n
int progress(int x1,int n1)
{
   if(n1==1)
        {

            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%d\t%|\t%c\t%|\t%c\n\n",32,32,32,32,32,32,x1,32,32);
        }
        else if(n1==2)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%d\t%|\t%c\n\n",32,32,32,32,32,32,32,x1,32);
        }
        else if(n1==3)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%d\n\n",32,32,32,32,32,32,32,32,x1);
        }
        else if(n1==4)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%d\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",32,32,32,x1,32,32,32,32,32);
        }
        else if(n1==5)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%d\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",32,32,32,32,x1,32,32,32,32);
        }
        else if(n1==6)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%d\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",32,32,32,32,32,x1,32,32,32);
        }
        else if(n1==7)
        {
            printf("\n\nCurrent Progress:\n\n\t%d\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",x1,32,32,32,32,32,32,32,32);
        }
        else if(n1==8)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%d\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",32,x1,32,32,32,32,32,32,32);
        }
        else if(n1==9)
        {
            printf("\n\nCurrent Progress:\n\n\t%c\t%|\t%c\t%|\t%d\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\t_\t\t_\t\t_\n\n\t%c\t%|\t%c\t%|\t%c\n\n",32,32,x1,32,32,32,32,32,32);
        }
}
